...
namespace AdvertisementApp.UI.Controllers
{
    public class AdvertisementController : Controller
    {
        ...
        public async Task<IActionResult> Send(int advertisementId)
        {
            ...
            ViewBag.militaryStatus = new SelectList(list, "Id", "Definitition");
        ...
        {
            var list = await _advertisementAppUserService.GetListAsync(AdvertisementAppUserStatusType.Mulakat);
